...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.LOGIN_USER_POOL_ID': JSON.stringify(process.env.LOGIN_USER_POOL_ID),
      'process.env.IDENTITY_POOL': JSON.stringify(process.env.IDENTITY_POOL),
      'process.env.LOGIN_APP_CLIENT_ID': JSON.stringify(process.env.LOGIN_APP_CLIENT_ID),
      'process.env.LOGIN_OAUTH_DOMAIN': JSON.stringify(process.env.LOGIN_OAUTH_DOMAIN),
